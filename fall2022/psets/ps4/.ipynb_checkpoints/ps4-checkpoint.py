...
def QuickSelect(arr, i):
    ...
    pivot_index_1 = get_random_index(arr)
    pivot_index_2 = get_random_index(arr)
    pivot_index_3 = get_random_index(arr)
    pivot = median([arr[pivot_index_1][0],arr[pivot_index_2][0],arr[pivot_index_3][0]])
    a_0 = [];
    a_1 = [];
    a_2 = [];
    ...
    if(i < len(a_0)):
        return QuickSelect(a_0, i)
    elif (i - len(a_0) < len(a_1)):
        return (a_1[0][0], a_1[0][1])
    else:
        return QuickSelect(a_2, i - len(a_0) - len(a_1))
...
#     for elt in arr:
#         if (elt[0] < arr[pivot_index][0]):
#             a_0.append(elt)
#         elif (elt[0] > arr[pivot_index][0]):
#             a_2.append(elt)
#         else:
#             a_1.append(elt)
...
def MergeSortSelect(arr, query_list):
    ...
    for elt in query_list:
        run_queries.append(sorted_arr[elt])
    return run_queries
